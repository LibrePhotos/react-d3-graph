...
function buildSvgSymbol(size = _node.default.DEFAULT_NODE_SIZE, symbolTypeDesc = _node.default.SYMBOLS.CIRCLE) {
...
function getLabelPlacementProps(dx, labelPosition) {
  switch (labelPosition) {
    case "right":
      return {
        dx: dx ? `${dx}` : _node.default.NODE_LABEL_DX,
        dy: "0",
    ...
    case "top":
      return {
        dx: "0",
        dy: dx ? `${-dx}` : `-${_node.default.NODE_LABEL_DX}`,
