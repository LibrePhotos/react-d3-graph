...
function toggleLinksConnections(d3Links, connectionMatrix) {
  return d3Links.map(d3Link => {
    ...
    const sourceId = (0, _graph.getId)(source);
    const targetId = (0, _graph.getId)(target); // connectionMatrix[sourceId][targetId] can be 0 or non existent
